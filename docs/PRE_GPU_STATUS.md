...
- The initial external judge paths were discontinued. The current protocol uses only pinned local open-weight WildGuard and HarmBench classifiers. Existing external-judge artifacts are diagnostic only.
